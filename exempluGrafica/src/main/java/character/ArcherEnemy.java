...
public class ArcherEnemy extends HumanoidEnemy {
    ...
    private int takesDamageOnRock = 65;

    private static final double RECOIL_ANGLE = 15;

    private int timeout = 0;

    private static final int THROW_ARROW_TIMEOUT = 180;
...
//        System.out.println("Am fost lovit!");
        ...
        if(this.hitCapacity < 0) {
            ...
            if(GET_HIT_TIMEOUT > this.timeout)
...
//            System.out.println(height + ", " + width);
            ...
            GameWindow.getInstance().enemyThrowsArrow((int)this.x, (int)this.y, degreeAngle);

            this.timeout = THROW_ARROW_TIMEOUT;
